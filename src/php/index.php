...
<html lang="ru-RU">
  <head>
    ...
    <meta name="Author" content="ФИО автора">
    <meta name="Copyright" content="кому принадлежат авторские права">
    <meta name="Address" content="адрес где создавался контент">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <nav class="col-12 col-sm-3">
            <ul>
              <li><a href="пункт меню">пункт меню</a></li>
              <li><a href="пункт меню">пункт меню</a></li>
              <li><a href="пункт меню">пункт меню</a></li>
              <li><a href="пункт меню">пункт меню</a></li>
              <li><a href="пункт меню">пункт меню</a></li>
      ...
      <div class="container">
        <section>
          <div class="row justify-content-between">
            <div class="card flex-grow-1" style="width: 18rem;"><img class="card-img-top" src="src/img/develop.png" alt="Отличное настроение">
              <div class="card-body">
            ...
            <div class="card flex-grow-1" style="width: 18rem;">
              <div class="card-body">
                <h2 class="card-title">Corporate<span>&nbsp;Training &nbsp;</span>and Development</h2>
                <p class="card-text">Sed odio morbi quis commodo odio aenean sed adipiscing. Eget nullam non nisi est sit. Enim nec dui nunc mattis enim ut. Ultricies mi eget mauris pharetra et ultrices. Faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis aliquam.</p>
              </div><img class="card-img-top" src="src/img/develop2.png" alt="Человек с ноутбуком">
            </div>
          </div>
          <div class="row">
            <div class="cont">
        ...
        <section>
          <div class="row">
            <div class="col-12 col-sm-6">
              <h3>We have helped more than<span>&nbsp;25.000 people</span>&nbsp; to relocate successfully.</h3>
              <p>Id ornare arcu odio ut. Posuere ac ut consequat semper viverra nam libero. Mus mauris vitae ultricies leo integer malesuada nunc. Rhoncus est pellentesque elit ullamcorper dignissim cras tincidunt lobortis. Viverra vitae congue eu consequat ac felis donec et odio. Nunc mattis enim ut tellus. Morbi quis commodo odio aenean sed adipiscing diam donec. Felis imperdiet proin fermentum leo vel orci. Adipiscing vitae proin sagittis nisl rhoncus mattis rhoncus. Proin sed libero enim sed faucibus. In ante metus dictum at tempor.</p>
            </div>
            <div class="col-12 col-sm-6">
              <div class="for_share">
                <div class="share"></div>
              </div>
              <p>Integer quis auctor elit sed vulputate mi sit. Quam elementum pulvinar etiam non quam lacus suspendisse faucibus. Rhoncus mattis rhoncus urna neque viverra. Cras pulvinar mattis nunc sed blandit. Cras fermentum odio eu feugiat. Gravida in fermentum et sollicitudin.</p>
            </div>
          </div>
        </section>
      </div>
                ...
                <div class="rows">
                  <div class="txt_block">
                    <div class="self_txt_block">
                      <h5>Consulting</h5>
                      <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur</p><a href="#">learn more</a>
                    </div>
                  </div>
    ...
    <div class="container-fuild">
      <section>
        <div class="container">
          <div class="row">
            <h1>Нужна качественная разработка для лендинга вашей мечты?</h1>
          </div>
          <div class="row">
            <div class="col-12 col-sm-9"><img src="src/img/1-foto.jpg">
              <div class="ove">
                <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" space="preserve" width="300" height="300" viewbox="0 0 180 180" fill="white">
          ...
          <div class="row">
            <div class="col-12 col-sm-10">
              <div class="col-12 col-sm-5">
                <div class="card">
                  <div class="card-body">
                    <div class="svg_card-body">
                      <svg preserveaspectratio="xMidYMin slice" width="100" height="100" viewbox="-230  -250 950 950" fill="blue">
                        <g>
                    ...
                    <h5 class="card-title">стратегия</h5>
              ...
              <div class="col-12 col-sm-5">
                <div class="card">
                  <div class="card-body">
                    <div class="svg_card-body">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" width="100" height="100" viewbox="-240 -250 970 970" fill="blue">
                        <g>
                          <g>
                    ...
                    <h5 class="card-title">ux Дизайн</h5>
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-5">
                <div class="card">
                  <div class="card-body">
                    <div class="svg_card-body">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" width="100" height="100" viewbox="-220 -250 950 950" fill="blue">
                        <g>
                          <g>
              ...
              <div class="col-12 col-sm-5">
                <div class="card">
                  <div class="card-body">
                    <div class="svg_card-body">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" width="100" height="100" viewbox="-10 -9 43 43" fill="blue">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-8">
              <div class="wrapper_work_team">
                <div class="wrapper_work_team_foto"></div>
              </div>
            </div>
            <div class="col-12 col-sm-4">
              <div class="wrapper_work_info">
                <div class="wrapper_work_info_txt">
                  <h6>About Us</h6>
                  <h2> Corporate Training and &nbsp;<span>Development</span></h2>
                  <p></p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-12 col-sm-6">
              <div class="location_wrap">
                <div class="location_wrap_addres">
                  <h4>location</h4>
                  <p class="lead">28 Jackson Blvd Ste 1020<br>Chicago  IL 60604-2340</p>
                </div>
                <div class="location_wrap_socnet">
                  <h4>follow us</h4>
                  <p class="lead"><a href="https://www.facebook.com"><img title="facebook" src="src/img/003-facebook-1.svg" alt="facebook"></a><a href="https://twitter.com/"><img title="twitter" src="src/img/004-twitter.svg" alt="twitter"></a><a href="https://www.instagram.com/"><img title="instagram" src="src/img/002-instagram.svg" alt="instagram"></a><a href="https://vk.com"><img title="vk" src="src/img/free-icon-vk-1051359.png" alt="vk"></a></p>
                  <p class="pt-4">&copy; Privacy policy</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <div class="contact_wrap">
                <div class="contact_wrap_form">
                  <h2>contact form</h2>
                  <form>
                    <input type="text" name="human_name" placeholder="Enter Your Name"><br>
                    <input type="email" name="human_email" placeholder="Enter a valid email addres"><br>
                    <textarea id="msg" name="human_msg" cols="30" rows="5"></textarea><br>
